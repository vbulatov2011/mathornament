...
export class Group {
  ...
  constructor(arg){
    ...
    } else if(this.fundDomain) {
        // default generators names are a,b,c,d,...
        this.genNames = this.fundDomain.map((_, i) => String.fromCharCode('a'.charCodeAt(0) + i));
    }
  ...
  init(){
    ...
    //
    //  return count of group generators ( == length of the fundamental domain) 
    //
    getGeneratorsCount(){
       return this.fundDomain.length;
    }
