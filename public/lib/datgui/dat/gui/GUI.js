...
import saveDialogueContents from './saveDialogue.html.js';
...
function augmentController(gui, li, controller) {
  ...
  if (controller instanceof NumberControllerSlider) {
    ...
    controller.updateDisplay = common.compose(function (val) {
      const colorObj = controller.__color;
      li.style.borderLeftWidth = '3px';
      li.style.borderLeftStyle = 'solid';
      li.style.borderLeftColor = `rgb(${Math.round(colorObj.r)}, ${Math.round(colorObj.g)}, ${Math.round(colorObj.b)})`;
      return val;
    }, controller.updateDisplay);
