...
function createImageButton(options){
    ...
    // Suppress the browser's default image-drag. draggable=false alone is ignored
    // by Chrome for <img> elements; a dragstart handler is the definitive fix.
    mImage.addEventListener('dragstart', evt => evt.preventDefault());
