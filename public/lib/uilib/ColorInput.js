...
function isColorString(text) {
    if (isString(text) && (text.charAt(0) === "#")) {
        const length = text.length;
        if ((length != 4) && (length != 5) && (length != 7) && (length != 9)) {
            return false;
        }
        for (var i = 1; i < length; i++) {
            if (hexDigits.indexOf(text.charAt(i)) < 0) {
                return false;
            }
        }
        return true;
...
// default colors
// for active button, depending on hovering and if it is pressed
ColorInput.colorUp = "#444444";
ColorInput.colorUpHover = "black";
ColorInput.colorDownHover = "black";
ColorInput.colorDown = "#444444";
ColorInput.backgroundColorUp = "white";
ColorInput.backgroundColorUpHover = "#ffffbb";
ColorInput.backgroundColorDownHover = "#ffff44";
ColorInput.backgroundColorDown = "#ffff88";
// for switched off
ColorInput.colorInactive = "black";
ColorInput.backgroundColorInactive = "#cccccc";
...
ColorInput.prototype.colorStyleDefaults = function() {
    this.colorUp = ColorInput.colorUp;
    this.colorUpHover = ColorInput.colorUpHover;
    this.colorDownHover = ColorInput.colorDownHover;
    this.colorDown = ColorInput.colorDown;
    this.colorInactive = ColorInput.colorInactive;

    this.backgroundColorUp = ColorInput.backgroundColorUp;
    this.backgroundColorUpHover = ColorInput.backgroundColorUpHover;
    this.backgroundColorDownHover = ColorInput.backgroundColorDownHover;
    this.backgroundColorDown = ColorInput.backgroundColorDown;
    this.backgroundColorInactive = ColorInput.backgroundColorInactive;
};
...
ColorInput.stringFromObject = function(obj) {
    var result;
    if (isDefined(obj.red) && isDefined(obj.green) && isDefined(obj.blue)) {
        result = "#" + hexString(obj.red) + hexString(obj.green) + hexString(obj.blue);
        if (isDefined(obj.alpha)) {
