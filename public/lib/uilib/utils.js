...
/**
 * Shows a temporary warning banner at the top of the page.
 * Auto-dismisses after `durationMs` (default 8 s). Click to dismiss early.
 * @param {string} message
 * @param {number} [durationMs=8000]
 */
export function showWarningBanner(message, durationMs = 8000) {
...
/**
 * Returns the file name (without extension) from a path or URL string.
 * e.g. "/presets/foo.json" → "foo"
 */
